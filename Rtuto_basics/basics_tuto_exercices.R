...
vect4 <- vect1 + vect3
# Recycling: when one vector is smaller than the other, the shorter one is completed using its own values. Its values are recycled.
...
# 2.1. Create a vector named x of length 200 going uniformely from 0 to 1 (hint: use the length.out argument of the function seq).
